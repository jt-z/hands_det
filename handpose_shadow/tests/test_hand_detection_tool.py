...
from handpose_shadow.config import FRAME_WIDTH, FRAME_HEIGHT
...
def main():
    ...
    source_group.add_argument("--image", type=str, default="D:\Documents\Onedrive\Documents\A_Dashboard\PartTime\HandPoseShadow\handpose_shadow\\tests\\tests_media\\test_frame.jpg", help="输入图片路径")
    ...
    # 输出设置
    parser.add_argument("--output", type=str, default="output", help="输出文件路径")
